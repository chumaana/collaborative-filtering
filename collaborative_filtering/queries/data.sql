...
insert into filtering_review (id, book_id, user_id, rate) values (4, 5, 2, 5);
insert into filtering_review (id, book_id, user_id, rate) values (5, 7, 2, 5);
insert into filtering_review (id, book_id, user_id, rate) values (6, 2, 2, 4);
